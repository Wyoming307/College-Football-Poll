...
This query should be used if the game is over and the game does not aleady exist in the "Game" table.
***/
DECLARE @Season INT = 0000;
DECLARE @Week INT = 0;
...
--INSERT INTO Game ( SeasonID, WeekTypeID, GameDate, HomeTeamID, HomeTeamPoints, AwayTeamID, AwayTeamPoints, ImportGameID)
